...
const Spotify = ({ windowsState, windowName, setWindowsState   }) => {
  return ( 
    <MacWindow width="20vw" height="45vh" x="1350" y="100" windowName={windowName} windowsState={windowsState} setWindowsState={setWindowsState}>
